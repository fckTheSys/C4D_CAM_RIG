"""CamRig 2 P3. Creates a separate rig; no legacy imports or scene upgrades."""
...
def controls(root):
    ...
    orbit = group(root, 'Orbit')
    path = group(root, 'Trajectory')
    free = group(root, 'Free')
...
def build(document, use_redshift=True):
    ...
    root.SetName('CamRig 2 PROTOTYPE')
    ...
    align[c4d.ALIGNTOSPLINETAG_LINK] = objects[4]
