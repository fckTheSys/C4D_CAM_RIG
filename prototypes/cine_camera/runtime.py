"""CamRig 2 P3 portable expression. Builder prepends its stable UD slot map.
...
PARENTS = {2: 1, 3: 1, 4: 1, 5: 1, 9: 5, 12: 9, 6: 12, 7: 6, 13: 7, 8: 13, 10: 1, 11: 1}
...
def execute(tag):
    ...
    circle, motion, aim, frame, camera = (objects[i] for i in range(4, 9))
    ...
    for key in ('movement_mode', 'aim_mode'):
