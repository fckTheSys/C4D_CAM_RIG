...
5. В **Look → Aim Mode** выберите World Target и назначьте объект сцены либо
   Local Target и передвигайте локальный Null через кнопку Target в панели.
   **Pan / Tilt / Roll** добавляют поправку к наведению. Manual
