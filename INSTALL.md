...
3. Restart Cinema 4D.
4. Check Script Log for `[CamRig] v1.5.0 loaded`.
...
Existing scenes are not upgraded automatically. See [Upgrade 1.5](docs/UPGRADE_1_5.md). Restart C4D after installing: a running Python process can still hold the old camrig modules.
