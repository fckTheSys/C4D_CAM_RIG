...
Есть [`CHANGELOG.md`](../CHANGELOG.md) в корне проекта и [`ARCHITECTURE.md`](ARCHITECTURE.md). Дальше — раздел «Обратная совместимость» в SUMMARY для редких старых сцен при необходимости.
